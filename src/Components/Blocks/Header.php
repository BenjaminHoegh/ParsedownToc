    ...
    public function stateRenderable()
    {
        return new Handler(
            ...
            function (State $State) {
                $HeaderSlug = new HeaderSlug(true);
                $Register = $State->get(SlugRegister::class);
                
                $id = $this->id();
                $classes = $this->classes();
                
                $id = (isset($id)) ? $HeaderSlug->transform($Register, $this->id()) : $HeaderSlug->transform($Register, $this->text());
                ...
                $TB = $State->get(TocBook::class);
                
                $TB->addTocElement($this->level(), $this->text(), $id); 
